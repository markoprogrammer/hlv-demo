      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
        <div className="md:col-span-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-8">
            {stats.map((stat) => (
              <div key={stat.label} className="bg-[#1a1a1a] rounded-2xl p-5">
        ...
        <div className="bg-[#1a1a1a] rounded-2xl p-8 flex flex-col justify-between">
          ...
          <div>
            ...
            <p className="text-white/50 text-sm">uptime garancija na production sistemima</p>
          </div>
