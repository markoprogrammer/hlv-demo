...
function MemberCard({ member }) {
    return (_jsxs("div", { className: "bg-[#1a1a1a]/80 rounded-2xl overflow-hidden hover:border hover:border-[#4fc273]/30 transition-all group", children: [_jsx("div", { className: "aspect-square overflow-hidden bg-[#111]", children: _jsx("img", { src: member.photo, alt: member.name, className: "w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" }) }), _jsxs("div", { className: "p-4", children: [_jsx("p", { className: "text-white font-medium text-sm", children: member.name }), _jsx("p", { className: "text-[#4fc273]/70 text-xs mt-0.5", children: member.role })] })] }));
}
export default function TeamGrid() {
    return (_jsx("section", { className: "py-16 px-6 md:px-16 lg:px-24", children: _jsx("div", { className: "max-w-7xl mx-auto", children: _jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4", children: [team.map((member) => (_jsx(MemberCard, { member: member }, member.name))), _jsx("div", { className: "bg-[#1a1a1a]/40 border border-dashed border-white/10 rounded-2xl aspect-square flex items-center justify-center", children: _jsxs("p", { className: "text-white/30 text-xs text-center px-2", children: ["+130 sjajnih", _jsx("br", {}), "kolega"] }) })] }) }) }));
}
